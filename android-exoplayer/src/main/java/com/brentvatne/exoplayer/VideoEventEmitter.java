...
class VideoEventEmitter {
    ...
    private static final String EVENT_RETURN_DOWNLOADS = " getAllDownloads";
    ...
    private static final String EVENT_DOWNLOAD_STATE = "DownloadState";
    ...
    private static final String EVENT_PROP_ALL_DOWNLOADS = "allDownloads";
    private static final String EVENT_PROP_DOWNLOAD_EXISTS = "getdownload";
    ...
    private static final String EVENT_PROP_DOWNLOAD_STATE = "downloadstt";
    private static final String EVENT_PROP_DOWNLOAD_PROGRESS = "downloadprogress";
    ...
    void getalldownloads(List<String> uriList) {
        WritableMap event = Arguments.createMap();
        WritableArray array = new WritableNativeArray();
        Log.d("Dispatched Event ","EVENT_PROP_ALL_DOWNLOADS");
        for (String co : uriList) {
            array.pushString(co);
    }
        event.putArray(EVENT_PROP_ALL_DOWNLOADS,array);
        receiveEvent(EVENT_RETURN_DOWNLOADS, event);
    }
   // getAllDownloadsList
