...
import static com.brentvatne.exoplayer.PlayerUtil.DOWNLOAD_NOTIFICATION_CHANNEL_ID;
...
public class PlayerDownloadService extends DownloadService {
  ...
  protected DownloadManager getDownloadManager() {
    ...
    DownloadManager downloadManager = PlayerUtil.getDownloadManager(/* context= */ this);
    DownloadNotificationHelper downloadNotificationHelper =
        PlayerUtil.getDownloadNotificationHelper(/* context= */ this);
