...
export default class Video extends Component {
  ...
  download = async(link,id) => {
    if (Platform.OS === 'android') {
      this.setNativeProps({ download: link,id });
    }else{
      return await NativeModules.VideoManager.save(link,id, findNodeHandle(this._root));
    }
  };
  ...
  deleteBook = async (options?) => {
    console.log("delete with ",options)
    return await NativeModules.VideoManager.deleteBook(options, findNodeHandle(this._root));
  }
